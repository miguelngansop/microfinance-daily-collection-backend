...
public class ClientController {
	...
	// Create a new Client of collecte
		  @PostMapping("/client/{idAgent}")
		  public Client createClientCollecte(@Valid @RequestBody Client cl, @PathVariable(value="idAgent") Long agentId) {
		      Agent a = new Agent();
		      a.setId(agentId);
			  cl.setAgent(a);
			  return clientRepo.save(cl);
