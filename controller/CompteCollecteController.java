...
// modification cette version supporte desormais les clients apportes par une collectrice et les operation des collectrice
			
	@PostMapping("/compteCollecte/{idClient}")
	public CompteCollecte createCompteCollecte( @PathVariable(value = "idClient") Long clientId,
	...
	public ResponseEntity<?> retrait(@PathVariable(value = "idCompte") Long compteId,
			@PathVariable(value="idAgent") Long agentId,
